...
public class SendDataRecorridoAdapter extends RecyclerView.Adapter<SendDataRecorridoAdapter.ViewHolder> {
...
//    private static final String TAG = "SendDataAdapter";
    ...
    public SendDataRecorridoAdapter(List<CuestionariosPendientes> cuestionariosPendientes, boolean[] checkeds,
    ...
    @Override
    public void onBindViewHolder(@NonNull SendDataRecorridoAdapter.ViewHolder holder, int position) {
